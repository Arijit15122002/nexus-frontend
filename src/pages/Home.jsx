...
import MobileAIHead from "../assets/mobile_robot.png";
      ...
      {isMobile ? (
        <>
          <div className="h-[100dvh] w-full relative">
           <div className="absolute h-[80%] w-[95vw] bottom-2/8 left-1/2 -translate-x-1/2 flex justify-center">
              <img src={MobileAIHead} alt="" className="h-full w-auto object-contain object-bottom"/>
            </div>
          </div>
        </>
      ) : (
              ...
              <div className="flex w-full flex flex-row justify-between items-start  absolute top-1/3 md:px-20 z-40 pointer-events-none">
                ...
                >
                  ...
                  >
                    ...
                    <div className="font-light text-sm">Start Building</div>
                    <div className="rounded-full bg-gradient-to-b from-orange-400 to-orange-600 border-orange-600 border-2 p-2">
