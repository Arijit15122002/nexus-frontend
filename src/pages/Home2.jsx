  ...
  return (
    <div className="relative min-h-[100svh] w-full overflow-x-hidden overflow-y-hidden flex flex-col items-center bg-white dark:bg-[#0a0a0a] transition-all duration-500 px-4">
      ...
      <motion.div
        ...
        className="absolute top-[30%] sm:top-[20%] md:top-[10%] z-10 flex flex-col items-center w-full"
      >
      ...
      <div className="relative w-full min-h-[100svh] flex items-end justify-center lg:justify-between max-w-[1600px]">
        ...
        >
          ...
          {/* BUTTON */}
          <div className="group relative w-fit h-[62px] px-[22px] rounded-full overflow-hidden cursor-pointer flex items-center gap-4 border border-orange-500/20 bg-[#151515]/90 backdrop-blur-xl transition-all duration-500 hover:scale-[1.04] hover:border-orange-400 hover:shadow-[0_0_50px_rgba(255,120,0,0.35)]">
        ...
        <motion.div
          ...
          className="absolute top-[15%] left-1/2 -translate-x-1/2 z-20 flex items-end justify-center w-full h-full pointer-events-none"
        >

          <img
            src={AiHead}
            alt="AI Head"
            className="w-[115vw] max-h-[500px] sm:w-[95vw] sm:max-h-[600px] md:w-[70vw] md:max-h-[700px] lg:w-[700px] max-w-none object-contain select-none"
          />
