  ...
  return (
    <div className="w-full h-full flex flex-row items-center justify-center">
      ...
      <div className={`${deviceType == "mobile" ? "" : "w-[1/2]"} relative`}>
        ...
        <div className={`${deviceType == "mobile" ? "" : "w-full"} flex flex-col justify-center items-center gap-2 exo text-[#232323]text-sm dark:text-[#fefefe] px-4 py-14 backdrop-blur-3xl rounded-3xl`}
      >
        {/* icon */}
        <svg
          className=""
