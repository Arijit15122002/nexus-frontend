  ...
  return (
    <div className="w-full h-full flex flex-row items-center justify-center">
      ...
      <div className={`${deviceType == "mobile" ? "" : "w-[1/2]"} relative`}>
        ...
        <div className={`${deviceType == "mobile" ? "" : "w-full"} flex flex-col justify-center items-center gap-2 exo text-[#232323] dark:text-[#fefefe] px-4 py-14 backdrop-blur-3xl rounded-3xl`}
      >
        {/* icon */}
        <svg
          className=""
        ...
        <div className="mt-4 px-6 py-8 flex flex-col items-center gap-3 rounded-xl">
          ...
          <button className="bg-[#232323] text-[#eeeeee] mt-8 pt-2.5 pb-3 px-20 sm:px-30 rounded-2xl hover:bg-blue-600 hover:text-white transition-all duration-300 dark:bg-[#efefef] dark:text-black cursor-pointer min-w-[220px]">Register</button>
        </div>
      </div>
      </div>
    </div>
