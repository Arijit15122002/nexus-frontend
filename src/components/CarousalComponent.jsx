...
export default function CarousalComponent() {
  ...
  return (
    ...
    <div className="relative w-[330px] h-[320px] flex flex-col items-center justify-center">
      ...
      <button
        onClick={prevSlide}
        className="cursor-pointer absolute left-0 top-[38%] -translate-y-1/2 z-50 w-9 h-9 rounded-full border border-white/10 bg-black/40 backdrop-blur-xl flex items-center justify-center text-white hover:bg-orange-500 transition-all duration-300 hover:scale-110 hover:shadow-[0_0_30px_rgba(255,120,0,0.45)]"
      >
        <ChevronLeft size={16} />
      </button>
      ...
      <button
        onClick={nextSlide}
        className="cursor-pointer absolute right-0 top-[38%] -translate-y-1/2 z-50 w-9 h-9 rounded-full border border-white/10 bg-black/40 backdrop-blur-xl flex items-center justify-center text-white hover:bg-orange-500 transition-all duration-300 hover:scale-110 hover:shadow-[0_0_30px_rgba(255,120,0,0.45)]"
      >
      ...
      >
        ...
        <div className="orbitron text-white text-[18px] tracking-[1px]">
          {center.title}
        </div>

        <div className="mt-2 exo text-white/40 text-[11px] leading-[20px] max-w-[240px]">
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 left-0 w-full flex justify-center">
        ...
        <div className="exo text-white text-[10px] tracking-[1px]">
          {slide.title}
        </div>
